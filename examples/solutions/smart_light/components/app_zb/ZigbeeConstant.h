...
#ifndef  ZIGBEE_CONSTANT_H
#define  ZIGBEE_CONSTANT_H
...
#define SIMPLE_DESCR_SMART_PLUG        0x0051   // ZHA Smart Plug
...
typedef enum
{
    E_ZB_DEVICEID_LIGHT_DIMMER              = 0x0101,
    E_ZB_DEVICEID_LIGHT_SENSOR              = 0x0106,
    E_ZB_DEVICEID_OCCUPANCY_SENSOR          = 0x0107,
    E_ZB_DEVICEID_LIGHT_COLOR_TEMP          = 0x010C,
    E_ZB_DEVICEID_LIGHT_COLOR_EXT           = 0x010D,    
    E_ZB_DEVICEID_SWITCH_DIMMER             = 0x0104,
    E_ZB_DEVICEID_ONOFF_BUTTON              = 0x0002,
    E_ZB_DEVICEID_ONOFF_SENSOR              = 0x0850,
    E_ZB_DEVICEID_CONTROL_BRIDGE            = 0x0840
} eZigbee_DeviceID;
