...
/**Heartbeat report**/
#define ZCL_HEARTBEAT_ZR_MIN_REPORT_INTERVAL    3
#define ZCL_HEARTBEAT_ZR_MAX_REPORT_INTERVAL    8
#define ZCL_HEARTBEAT_ZED_MIN_REPORT_INTERVAL   5
#define ZCL_HEARTBEAT_ZED_MAX_REPORT_INTERVAL   65
