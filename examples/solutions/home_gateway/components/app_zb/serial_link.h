...
#define ntohs(n) ((uint16_t)((((n) & (uint16_t)0x00ffU) << 8) | (((n) & (uint16_t)0xff00U) >> 8)))
//((uint16_t)((((n) << 8) & 0xff00) | (((n) >> 8) & 0x00ff)))
#define ntohl(n) ((uint32_t)((((n) << 24) & 0xff000000) | (((n) << 8) & 0x00ff0000) | \
                  (((n) >> 8) & 0x0000ff00) | (((n) >> 24) & 0x000000ff)))
#define ntohd(n) ((uint64_t)((((n) << 56) & 0xff00000000000000) | (((n) << 40) & 0x00ff000000000000) | \
